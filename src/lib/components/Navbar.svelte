...
<div class="navbar bg-base-300 shadow-lg">
	<div class="navbar-start">
			...
			>
				...
				<li>
					<details>
						...
						<ul class="p-2">
							<li><a href="/course/1">Scientific Method</a></li>
							<li><a href="/course/2">Research Methods in Psychology</a></li>
							<li><a href="/course/3">Introduction to Cognitive Psychology</a></li>
						</ul>
					</details>
				</li>
		...
		<a href="/" class="btn btn-ghost text-xl">
			<img src="/svg/brain_logo_side.svg" alt="Brain Logo" class="h-8 w-8" />
